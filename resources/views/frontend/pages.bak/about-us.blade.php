...
@section('main-content')
    ...
    <div class="section pt-4 px-3 px-lg-4" id="about">
        <div class="container-narrow">
          <div class="row">
            <div class="col-md-6">
              <h2 class="h4 my-2">Hello! I’m Joy Vinensius Meliala.</h2>
              ...
              <div class="row mt-3">
                ...
                <div class="col-sm-10">
                  <div class="pb-1 fw-bolder">0822-9791-4147</div>
                </div>
                <div class="col-sm-2">
                  <div class="pb-1">Address:</div>
                </div>
                <div class="col-sm-10">
                  <div class="pb-1 fw-bolder">Jalan Pembangunan No. 3 No. 3 RT.012 RW.01</div>
                  <div class="pb-1 fw-bolder">Kel. Cipinang Melayu Kec. Makasar,</div>
                  <div class="pb-1 fw-bolder">Jakarta Timur,13620</div>
                </div>
                <div class="col-sm-2">
            ...
            <div class="col-md-5 offset-md-1" data-aos="fade-left" data-aos-delay="100"><img class="avatar img-fluid mt-2" src="images/joy.jpg" width="400" height="400" alt="Walter Patterson"/></div>
          </div>
        </div>
      </div>
