    ...
    <div class="card-body">
      <form method="post" action="{{route('job.update',$job->id)}}">
        ...
        <div class="form-group">
          ...
          <input id="inputTitle" type="text" name="nama_perusahaan" placeholder="Enter Perusahaan"  value="{{$job->nama_perusahaan}}" class="form-control">
