...
<div class="card">
    ...
    <form method="post" action="{{route('settings.update')}}">
        ...
        <div class="form-group">
            <label for="nama" class="col-form-label">Nama Lengkap <span class="text-danger">*</span></label>
        ...
        <div class="form-group">
          ...
          <select name="status" class="form-control">
            ...
            <option value="I Working Now" {{(($data->status=='I Working Now') ? 'selected' : '')}}>I Working Now</option>
          </select>
          @error('status')
          <span class="text-danger">{{$message}}</span>
          @enderror
